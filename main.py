...
from Exp.sttf_trainer import Exp
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Train STTF')
...
if __name__ == "__main__":
    ...
    exp_id = f'exp_bs128_road{Config.road_trm_layer}_inter{Config.inter_trm_layer}_epoch30_2e-4_cls_{Config.mask_length}_{Config.mask_ratio}ratio'
