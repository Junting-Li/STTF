...
class Exp:
    ...
    def train(self):
        ...
        for epoch in range(self.start_epoch, self.epochs):
            ...
            for i, batch_data in enumerate(train_bar):
                ...
                cl_loss, mlm_loss, mlm_prediction = self.model(road_data)
                ...
                train_bar.set_description(f'[STTF Train Epoch {epoch}/{self.epochs}: loss: {loss:.10f}]')
    ...
    def _eval(self, epoch):
        ...
        for batch_data in eval_bar:
            ...
            eval_bar.set_description(f'[STTF Eval  Epoch {epoch}/{self.epochs}: loss: {loss:.10f}]')
