...
def contruct_directed_knowledge_graph():
    ...
    porto_edge_type = np.zeros((only_road_network.shape[0], 1), dtype=int)
    porto_with_edge_type = np.concatenate((only_road_network, porto_edge_type), axis=1)
    ...
    fusion_graph = np.concatenate((porto_with_edge_type, traj_edge_in_road_network_edge_type,
