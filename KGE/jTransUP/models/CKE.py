...
class CKE(nn.Module):
    def __init__(self,
        ...
        # normalize_ent_emb = F.normalize(self.ent_embeddings.weight.data1, p=2, dim=1)
        normalize_rel_emb = F.normalize(self.rel_embeddings.weight.data, p=2, dim=1)
        # normalize_proj_emb = F.normalize(self.proj_embeddings.weight.data1, p=2, dim=1)

        # self.ent_embeddings.weight.data1 = normalize_ent_emb
        self.rel_embeddings.weight.data = normalize_rel_emb
        # self.proj_embeddings.weight.data1 = normalize_proj_emb
