...
def get_flags():
    ...
    gflags.DEFINE_enum("dataset", "porto", ["ml1m", "dbbook2014", "amazon-book", "last-fm", "yelp2018", 'gowalla', 'foursquare', 'porto', 'newyork'],
    ...
    # todo: only eval when no train.dat when load data1
    gflags.DEFINE_boolean(
        "eval_only_mode",
        False,
